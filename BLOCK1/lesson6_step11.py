...
# первая ссылка: http://suninjuly.github.io/registration1.html (ожидаемый результат - тест пройдет без ошибок)
# вторая ссылка: http://suninjuly.github.io/registration2.html (ожидаемый результат - тест найдет багу)
# вставь ссылку для проверки кода сюда и не забудь сохранить файл перед запуском:
link = ""
